    ...
    <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white dark:bg-gray-900 p-6 rounded-[2rem] border shadow-sm sticky top-0 z-30">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-black">New Article</h1>
            <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Editor Mode</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            {loading ? <Loader2 className="h-4 w-4 animate-spin" /> : <><Save className="h-4 w-4 mr-2" /> Save Article</>}
          </Button>
        </div>
      </div>
