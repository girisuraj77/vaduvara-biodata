...
const TEMPLATE_COLORS: Record<string, { bg: string; primary: string; accent: string; text: string; label: string }> = {
  ...
  "regal-gold-frame": { bg: "#FFFFFF", primary: "#5C4712", accent: "#AD8712", text: "#3D3117", label: "#5C4712" },
  "regal_gold_frame": { bg: "#FFFFFF", primary: "#5C4712", accent: "#AD8712", text: "#3D3117", label: "#5C4712" },
  "royal-teal-gold": { bg: "#204A56", primary: "#E3B94E", accent: "#CBA24C", text: "#D6E3E5", label: "#EAF2F3" },
  "royal_teal_gold": { bg: "#204A56", primary: "#E3B94E", accent: "#CBA24C", text: "#D6E3E5", label: "#EAF2F3" },
  "traditional-marathi": { bg: "#F9F6EE", primary: "#2C221E", accent: "#4A3B32", text: "#3A2E2B", label: "#2C221E" },
  "traditional_marathi": { bg: "#F9F6EE", primary: "#2C221E", accent: "#4A3B32", text: "#3A2E2B", label: "#2C221E" },
